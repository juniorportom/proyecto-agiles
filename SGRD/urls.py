...
urlpatterns = [
    ...
    path('crear-plan-produccion/<int:idRecurso>', CrearPlanProduccion.as_view(), name='crear-plan'),
    path('editar-plan-produccion/<int:idPlan>', views.EditarPlanProduccion, name='editar-plan'),
